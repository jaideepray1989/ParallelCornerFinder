...
/**
 * Computes the features of a given stroke. Can choose from defined feature
 * sets, and can also standardize a stroke to a default bounding box width or
 * height.
 * 
 * @author Aaron Wolin
 */
public class Features {
	 ...
	 *            Feature set to use
	 * @param standardize
	 *            Should the stroke be standardized?
	 */
	...
	/**
	 * Calculates the features for a gesture stroke and returns the feature
	 * vector
	 * 
	 * @param stroke
	 *            Gesture stroke
	 ...
	 * 
	 * @param s
	 *            Stroke to calculate features for
	 * @param f
	 *            Feature set
	 */
	...
	/**
	 * Checks to see if a line segment with a given segment length intersects
	 * any other segments of similar length within the stroke points
	 * 
	 * @param pts
	 *            Points of the stroke
	 * @param startSegment
	 *            Starting index of our segment
	 * @param segLength
	 *            Length of the segment
	 * @return True if there is an intersection, false otherwise
	 */
	private boolean checkForIntersection(List<TPoint> pts, int startSegment,
			int segLength) {
		int numPts = pts.size();
	 ...
	 * 
	 * @param pt1
	 *            End point 1 of segment 1
	 * @param pt2
	 *            End point 2 of segment 1
	 * @param pt3
	 *            End point 1 of segment 2
	 * @param pt4
	 *            End point 2 of segment 2
	 * @return True if there is an intersection, false otherwise
	 */
	private boolean isIntersection(TPoint pt1, TPoint pt2, TPoint pt3,
			TPoint pt4) {
		// A
		double Ax = pt1.getX();
		double Ay = pt1.getY();
	...
	/**
	 * Calculate the pixel density of the gesture by using the stroke length and
	 * the bounding box area. Here we're assuming that stroke length is
	 * approximately equal to the number of pixels filled.
	 * 
	 * @param strokeLength
	 *            Length of the stroke
	 * @param boundingBoxArea
	 *            Area of the gesture
	...
	private double omegaP(TStroke s, int p, Point2D.Double[] delta) {
		double y = (delta[p].x * delta[p - 1].y)
				- (delta[p - 1].x * delta[p].y);
		double x = (delta[p].x * delta[p - 1].x)
				+ (delta[p].y * delta[p - 1].y);
